...
Для разработанного приложение провести внедрение в организацию не представляется возможным, так как приложение расчитано на установку обычным пользователям.
...
#ch("Приложение Б Дополнение к техническому заданию")
