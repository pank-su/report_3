...
Дополнение к техническому заданию по протоколу разногласий представлено в приложении Б.
...
- Проверить управление воспроизведением (воспроизведение, пауза, остановка, перемотка вперед/назад, переход к следующей/предыдущей песне).
- Проверить отображение информации о песне (название, исполнитель, альбом, обложка).
- Найти музыку по названию, исполнителю, альбому.
- Добавление музыки в понравившиеся.
...
#figure(
	...
	],[Отображение карты на всех устройствах, как на рисунке ],[Отображение карты на всех устройствах, как на рисунке ],[Пройден],
...
Базы данных используемые приложением: PostgreSQL, SQLite.
Система должна работать на современных системах: Windows 11 с поддержкой DirectX 12, MacOS версии выше Catalina, Linux 6.0 и выше с визуальным окружением Gnome 40 и выше, Android 10 и выше, IOS 16 и выше.
    ],
